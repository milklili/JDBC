...
public class AlterCourse extends JFrame implements ActionListener    {
	JTextField textcid;
	JLabel label_cid;
	...
	public  String tid;
	public  String time;
	public AlterCourse(String x,String y,String z,String w) {
		super();
	  								// 设置窗体可关闭－－－必须
		setTitle("修改课程");						// 设置窗体标题－－－必须
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == buttonadd){
			...
			{
				String sql="update course set cname='"+b+"',tid='"+c+"',grade='"+d+"',hour='"+f+"' where cid='"+a+"'";
				update(sql);
			}
